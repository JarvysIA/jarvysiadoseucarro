/**
 * Fixture válida — Fiat Argo 1.0 Flex 2023.
 *
 * Demonstra:
 * - timing_system = "corrente" (motor Firefly 1.0)
 * - kit_correia_dentada como not_applicable (regra crítica do Jarvys)
 * - Bundles SEM kit_correia_dentada comprável
...
export const fiatArgo2023Plan: MaintenancePlanJson = {
  schema_version: MAINTENANCE_PLAN_SCHEMA_VERSION,
  vehicle_summary: {
    display_name: "Fiat Argo 1.0 Flex 2023",
    marca: "Fiat",
    modelo_fipe: "Argo Drive 1.0 Flex 6V 5p",
    ano_modelo: 2023,
    combustivel: "Flex",
    cilindradas: 999,
    motor_textual: "1.0 Firefly Flex",
    valvulas: 6,
    transmissao: "manual",
  },
  base_rules: {
  ...
  milestones: [
    {
      ...
      items: [
        ...
        },
        {
          ...
          applies: false,
          reason: "Motor identificado com corrente de comando.",
          source_type: "manual",
          confidence: 95,
        },
      ],
    ...
    },
    {
      ...
      purchase_bundle_keys: ["kit_ignicao"],
    },
    {
      km: 60000,
  ...
  severe_use_rules: [
    {
      ...
      description:
        "Em uso severo (trânsito intenso, etanol contínuo, viagens curtas), reduzir intervalo.",
      interval_km: 5000,
      interval_months: 6,
  ...
  not_applicable_items: [
    {
      item_key: "kit_correia_dentada",
      label: "Kit correia dentada",
      reason: "Motor Firefly 1.0 utiliza corrente de comando.",
      source_type: "manual",
      confidence: 95,
    },
  ],
  purchase_bundles: [
    ...
    {
      bundle_key: "kit_ignicao",
      label: "Kit ignição",
      description: "Velas de ignição compatíveis com motor Firefly 1.0.",
      bundle_type: "kit_ignicao",
      item_keys: ["velas_ignicao"],
      category: "ignicao",
      shopping_classification: "safe_to_buy",
      preferred_search_query_template:
        "velas ignição {modelo} {motor} {ano_modelo}",
      required_item_keys: ["velas_ignicao"],
      requires_compatibility_confirmation: true,
      confidence: 85,
      source_type: "catalogo",
    },
  ...
  general_notes: [
    "Plano Jarvys para motor com corrente de comando — nunca sugerir troca de correia dentada.",
  ],
  safety_disclaimer:
