...
// createServerFn abaixo pra ficar testável sem precisar subir o runtime
// do TanStack Start — nenhum precedente de teste foi encontrado pra
// nenhum *.functions.ts em src/lib (confirmado por busca exaustiva antes
// de escrever isto), então esta é a abordagem mais simples e consistente
// com o padrão já comprovado em supabase/functions/_shared/whatsapp/
// orchestrator/ (client estrutural injetado, sem mock.module).
 ...
 * ver runGenerateVehicleImage acima.
 */
