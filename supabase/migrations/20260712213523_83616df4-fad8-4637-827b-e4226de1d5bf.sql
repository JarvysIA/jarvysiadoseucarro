-- BUILD 5.7F2E1A.5-ME2 — Adiciona 'km_reported' à allowlist c_event_kinds da RPC
-- apply_whatsapp_orchestrator_transition. Única mudança funcional: um literal.
-- Assinatura, retorno, SECURITY DEFINER, search_path, corpo e demais validações
-- preservados integralmente. confirm_km_update permanece rejeitado.
