-- BUILD 5.7F2E1A.5-ME2 — Allowlist: adiciona 'km_reported' em c_event_kinds
-- Única mudança funcional: um literal adicionado ao array c_event_kinds.
-- Assinatura, retorno, segurança, search_path, grants e corpo preservados.
...
DECLARE
  ...
  c_event_kinds      constant text[] := ARRAY['greeting','help','confirm','deny','cancel_task','reset_conversation','vehicle_reply','unknown','expired_state','km_reported'];
